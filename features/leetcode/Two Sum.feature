Feature: Two Sum
  ...
  Scenario Outline: Numbers
     Given some integer <numbers>
       And an integer <target> number
      When two_sum is invoked
      Then it returns 2 <indices> of the <two_numbers>
       And they add up to <target>

    Examples:
    |   case   |   numbers    | target | indices | two_numbers |
    |          | 2, 7, 11, 15 |      9 |  0, 1   | 2, 7        |
  # |          | 3, 2, 4      |      6 |  1, 2   | 2, 4        |
  # | 3 x2     | 3, 3         |      6 |  0, 1   | 3, 3        |
...
#        And an integer <target> number
#       When two_sum is invoked
#       Then it returns a tuple of <indices> of the <two_numbers>
#        And they add up to <target>
...
# # # | 110 x2  | [110, 110]     |    240 | [0, 1]  | 110, 110    | # Negative test: value.-  outside constraints
  ...
  #      And an integer <target> number
  #     When two_sum is invoked
  #     Then it returns <indices> of the <two_numbers>
  #      And they add up to <target>
